...
impl Paint {
    pub(crate) fn of(red: u8, green: u8, blue: u8) -> Paint {
...
impl Cut {
    ...
    pub(crate) fn of(shown: i64, needs: i64, marking: Marking) -> Cut {
...
pub(crate) struct Drawn {
    ...
    /// and down.
    pub(crate) across: Overflow,
    pub(crate) down: Overflow,
...
impl Drawn {
    ...
    pub(crate) fn called(&self) -> String {
    ...
    pub(crate) fn operable(&self) -> bool {
        matches!(
            self.tag.as_str(),
    ...
    pub(crate) fn landmark(&self) -> bool {
        matches!(
            self.tag.as_str(),
...
pub(crate) struct Page {
    ...
    pub(crate) painted_by: PaintSource,
}
